...
<java version="1.6.0_26" class="java.beans.XMLDecoder"> 
 <object class="com.ti.dvt.datamodel.core.DataModel"> 
  <void property="filePath"> 
   <string>C:\Arquivos\Doutorado\Sincrotron\Implementacao\.metadata\.plugins\com.ti.dvt.graph.visualization\savedSolutions\2</string> 
  </void> 
  <void method="addSource"> 
   <object class="com.ti.dvt.datamodel.ccsgraphs.CCSGraphsJtagDataSource"> 
    ...
    <void property="startAddress1Expr"> 
     <string>&amp;inVectPu</string> 
    </void> 
    <void property="startAddress2"> 
     <long>41280</long> 
    </void> 
    <void property="startAddress2Expr"> 
     <string>&amp;piOutVect</string> 
    </void> 
   </object> 
  </void> 
 </object> 
